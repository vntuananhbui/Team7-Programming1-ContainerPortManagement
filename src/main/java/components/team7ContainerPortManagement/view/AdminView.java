...
//        Port port = new Port("p-port6", "2", 2012.000000, 12.000000, 2000, true);

//        Container Container = new Container("12",200, ContainerType.REFRIGERATED, port);
        ...
        do {
            ...
            switch (option) {
                ...
                case 1:
                    ...
                    // parameters.
                    Port port = new Port(idNumber, portName, latitude, longitude, storingCapacity, landingAbility);
                    // Call add() record
                    admin.addPort(port);
                ...
                // Case 5
                case 5:
                    // display port save in file
                    admin.displayAllPorts();
                    break;
                case 16:
...
//                    break;
        ...
        while (option != 20);
            ...
            public static void menu() {
                ...
                System.out.printf("%-25s%n", "16: Add Port to Port Manager");
